...
class RuntimeSettingsTests(unittest.TestCase):
    def test_vision_tracking_uses_safe_rc_override_defaults(self):
        ...
        self.assertNotIn("desired_z_m", text)
        self.assertNotIn("visual_pid", text)
        ...
        self.assertIn("pre_align_docking_center_offset_camera_x_m: 0.03", text)
        self.assertIn("pre_align_docking_center_offset_camera_y_m: 0.06", text)
        self.assertIn("pre_align_docking_center_tolerance_m: 0.01", text)
        self.assertIn("pre_align_docking_center_release_hysteresis_m: 0.05", text)
        self.assertIn("docking_timeout_s: 180", text)
